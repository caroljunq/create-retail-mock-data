...
for i in range(n_logs):	
    ...
    logs += str(ip)+" - - ["+order_date+" +0000] \"GET / HTTP/1.1\" 200 38 \"id_cliente="+str(customer_id)+"&id_campaign="+str(campaign_id)+"&source="+str(media_source)+"&prod_id="+str(product_id)+" "+logs_headers[seed2] + "\n"


# saving file
print("Saving file...")
file_path = out_path + outfile
file_logs = open(file_path,"w")
